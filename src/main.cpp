...
int64 nChainStartTime = 1528461113;
...
const string strMessageMagic = "Dogzcoin Signed Message, sun:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    if(nHeight <= 0 * YEARLY_BLOCKCOUNT)
        nRewardCoinYear = 0 * MAX_MINT_PROOF_OF_STAKE; //first year 5%
    else
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Dogzcoin
    bool fStrictPayToScriptHash = true; // Always active in Dogzcoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Dogzcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "dogz TO MOON and SUN, BY STORM KNIGHT";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x3807a82ac084ef01760e58cd73e773410c43a0b2e01541d776d48b0023b155a7"));
